...
Original file is located at
    https://colab.research.google.com/drive/18ijvPSMRFMgBhuvDO2DpTDIne1cYSDpt
"""
...
# Display the first 5 rows and column information to understand the structure
display(df.head())
df.info()
...
class VideoRanker:
    ...
    def apply_filters(self,
        ...
        Args:
            rag_results: Original results from ChromaDB (can have many videos)
